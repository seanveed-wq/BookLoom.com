...
.modal-content input{padding:10px;border-radius:8px;border:none;outline:none;width:100%;}
.modal-content button{padding:10px;border-radius:8px;border:none;font-weight:700;cursor:pointer;}
.modal-content #result{color:#ff5cac;margin-top:8px;text-align:center;}
.close-btn{align-self:flex-end;background:transparent;color:#fff;font-size:20px;font-weight:800;cursor:pointer;border:none;}
...
<div class="header">
  ...
  <div>
    <button class="btn btn-ghost" onclick="openModal()">Sign in</button>
...
// Modal functions
window.openModal = ()=>document.getElementById('loginModal').style.display='flex';
...
window.signup = ()=>{
  ...
  .then(userCredential=>{
    document.getElementById('result').innerText="Signup successful! Redirecting...";
